...
import btn_icon_back_lunch2 from './images/btn_icon_back_lunch2.png';

// UI framework component imports
import Appbar from 'muicss/lib/react/appbar';


export default class Lunch2Screen extends Component {
  ...
  render() {
    ...
    const dataSheet_lunch = this.props.dataSheets['lunch'];
    const style_elCard = {
        width: '100%',
        height: '100%',
     };
    ...
    let items_list = [];
    let listComps_list = {};
    items_list = items_list.concat(this.props.appActions.getDataSheet('lunch').items);
    
    
    return (
      <div className="AppScreen Lunch2Screen" style={baseStyle}>
        ...
        <Appbar className="navBar">
          <div className="title">Lunch</div>  <div className="backBtn" onClick={ (ev)=>{ this.props.appActions.goBack() } }><img src={btn_icon_back_lunch2} alt="" style={{width: '50%'}} /></div>
        </Appbar>
