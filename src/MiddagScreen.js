...
import btn_icon_back_middag from './images/btn_icon_back_middag.png';

// UI framework component imports
import Appbar from 'muicss/lib/react/appbar';


export default class MiddagScreen extends Component {
  ...
  render() {
    ...
    const dataSheet_middag2 = this.props.dataSheets['middag2'];
    const style_elCard = {
        width: '100%',
        height: '100%',
     };
    ...
    let items_list = [];
    let listComps_list = {};
    items_list = items_list.concat(this.props.appActions.getDataSheet('middag2').items);
    
    
    return (
      <div className="AppScreen MiddagScreen" style={baseStyle}>
        ...
        <Appbar className="navBar">
          <div className="title">Middag</div>  <div className="backBtn" onClick={ (ev)=>{ this.props.appActions.goBack() } }><img src={btn_icon_back_middag} alt="" style={{width: '50%'}} /></div>
        </Appbar>
